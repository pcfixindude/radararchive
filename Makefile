...
mrms-bulk-local-ingest:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_bulk_local_ingest.py $(ARGS)

mrms-ingest-window:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_ingest_window.py $(ARGS)

local-replay-ready:
	. .venv/bin/activate && PYTHONPATH=. python scripts/local_replay_ready.py $(ARGS)

playback-export:
	. .venv/bin/activate && PYTHONPATH=. python scripts/playback_export.py $(ARGS)

clip-import:
	. .venv/bin/activate && PYTHONPATH=. python scripts/clip_import.py $(ARGS)

clip-remediation:
	. .venv/bin/activate && PYTHONPATH=. python scripts/clip_remediation.py $(ARGS)

frame-quality:
	. .venv/bin/activate && PYTHONPATH=. python scripts/frame_quality.py $(ARGS)

mrms-warm-frame-cache:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_warm_frame_cache.py $(ARGS)
...
mrms-render-candidate-preflight-blockers:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_preflight_blockers.py $(ARGS)
...
mrms-render-candidate-gated-sandbox-layout:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_gated_sandbox_layout.py $(ARGS)
...
mrms-render-candidate-gated-comparison-ack:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_gated_comparison_ack.py $(ARGS)
...
mrms-render-candidate-sandbox-comparison-acknowledgment-status-trend-hint:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_sandbox_comparison_acknowledgment_status_trend_hint.py $(ARGS)

mrms-render-candidate-sandbox-comparison-acknowledgment-status-trend-review-acknowledgment:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_sandbox_comparison_acknowledgment_status_trend_review_acknowledgment.py $(ARGS)

mrms-render-candidate-sandbox-comparison-acknowledgment-status-trend-review-acknowledgment-status:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_sandbox_comparison_acknowledgment_status_trend_review_acknowledgment_status.py $(ARGS)

mrms-render-candidate-sandbox-comparison-acknowledgment-status-trend-review-acknowledgment-status-history:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_sandbox_comparison_acknowledgment_status_trend_review_acknowledgment_status_history.py $(ARGS)

mrms-render-candidate-sandbox-comparison-acknowledgment-status-trend-review-acknowledgment-status-trend-hint:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_sandbox_comparison_acknowledgment_status_trend_review_acknowledgment_status_trend_hint.py $(ARGS)

mrms-render-candidate-sandbox-comparison-acknowledgment-status-trend-review-acknowledgment-status-trend-review-acknowledgment:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_sandbox_comparison_acknowledgment_status_trend_review_acknowledgment_status_trend_review_acknowledgment.py $(ARGS)
...
mrms-render-candidate-sandbox-comparison-acknowledgment-status-trend-review-acknowledgment-status-trend-review-acknowledgment-status:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_sandbox_comparison_acknowledgment_status_trend_review_acknowledgment_status_trend_review_acknowledgment_status.py $(ARGS)

mrms-render-candidate-sandbox-comparison-acknowledgment-status-trend-review-acknowledgment-status-trend-review-acknowledgment-status-history:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_sandbox_comparison_acknowledgment_status_trend_review_acknowledgment_status_trend_review_acknowledgment_status_history.py $(ARGS)
...
mrms-render-candidate-trend-hint-ack-status-history:
	. .venv/bin/activate && PYTHONPATH=. python scripts/mrms_render_candidate_trend_hint_ack_status_history.py $(ARGS)
