...
- `make operator-workflow-presets` lists local operator workflow presets with recommended flags (`--json`); Dev Validation **Operator Workflow Presets** collapsible near Operator Review Status
