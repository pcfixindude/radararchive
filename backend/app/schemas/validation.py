...
class MrmsRenderCandidateReviewReadinessCompact(BaseModel):
    available: bool = False
    chain_readiness_level: Optional[str] = None
    overall_readiness_level: Optional[str] = None
    review_chain_ready: bool = False
    preflight_blocked: bool = True
    preflight_candidate_ready: bool = False
    gated_preflight_still_blocked: bool = True
    blocking_items: list[str] = Field(default_factory=list)
    warnings: list[str] = Field(default_factory=list)
    next_operator_step: Optional[str] = None
    ...
    regeneration_suggested_command: Optional[str] = None
    computed_at: Optional[str] = None
    json_path: Optional[str] = None
    markdown_path: Optional[str] = None
    suggested_command: Optional[str] = None
    next_phase_recommendation: Optional[str] = None
    verified_mrms: bool = False
    local_readiness_summary_only: bool = True
    advisory_only: bool = True
    does_not_clear_alerts: bool = True
    does_not_enable_production: bool = True
    does_not_download_or_decode: bool = True
...
class MrmsRenderCandidateReviewReadinessResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_readiness_summary_only: bool = True
    advisory_only: bool = True
    ...
    gated_preflight_ready_is_not_production_authorization: bool = True
    latest: dict[str, Any] = Field(default_factory=dict)
    compact: MrmsRenderCandidateReviewReadinessCompact


class MrmsRenderCandidatePreflightAttemptCompact(BaseModel):
    available: bool = False
    ...
    preflight_markdown_path: Optional[str] = None
    suggested_command: Optional[str] = None
    next_phase_recommendation: Optional[str] = None
    verified_mrms: bool = False
    local_preflight_attempt_only: bool = True
    advisory_only: bool = True
    does_not_clear_alerts: bool = True
    does_not_enable_production: bool = True
    does_not_download_or_decode: bool = True
...
class MrmsRenderCandidatePreflightAttemptResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_preflight_attempt_only: bool = True
    advisory_only: bool = True
...
class MrmsRenderCandidateTrendHintChainBootstrapCompact(BaseModel):
    available: bool = False
    bootstrap_status: Optional[str] = None
    trend_hint_chain_ready: bool = False
    trend_hint_blockers: list[str] = Field(default_factory=list)
    visual_blockers: list[str] = Field(default_factory=list)
    ...
    next_phase_recommendation: Optional[str] = None
    verified_mrms: bool = False
    local_chain_bootstrap_only: bool = True
    advisory_only: bool = True
    does_not_clear_alerts: bool = True
    does_not_enable_production: bool = True
    does_not_download_or_decode: bool = True
...
class MrmsRenderCandidateTrendHintChainBootstrapResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_chain_bootstrap_only: bool = True
    advisory_only: bool = True
...
class MrmsRenderCandidateGatedDryRunReviewCompact(BaseModel):
    available: bool = False
    review_status: Optional[str] = None
    preflight_level: Optional[str] = None
    preflight_reason: Optional[str] = None
    preflight_blocking_items: list[str] = Field(default_factory=list)
    dry_run_plan_skipped: bool = True
    dry_run_plan_status: Optional[str] = None
    dry_run_plan_reason: Optional[str] = None
    dry_run_plan_blocking_items: list[str] = Field(default_factory=list)
    resolution_status: Optional[str] = None
    remaining_blockers: list[str] = Field(default_factory=list)
    preflight_not_run: bool = True
    preflight_candidate_ready: bool = False
    ...
    next_phase_recommendation: Optional[str] = None
    verified_mrms: bool = False
    local_gated_dry_run_review_only: bool = True
    advisory_only: bool = True
    does_not_clear_alerts: bool = True
    does_not_enable_production: bool = True
    does_not_download_or_decode: bool = True
...
class MrmsRenderCandidateGatedDryRunReviewResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_gated_dry_run_review_only: bool = True
    advisory_only: bool = True
...
class MrmsRenderCandidateGatedSandboxLayoutCompact(BaseModel):
    available: bool = False
    review_status: Optional[str] = None
    preflight_level: Optional[str] = None
    preflight_reason: Optional[str] = None
    ...
    sandbox_blockers: list[str] = Field(default_factory=list)
    ...
    next_phase_recommendation: Optional[str] = None
    verified_mrms: bool = False
    local_gated_sandbox_layout_only: bool = True
    advisory_only: bool = True
    does_not_clear_alerts: bool = True
    does_not_enable_production: bool = True
    does_not_download_or_decode: bool = True
...
class MrmsRenderCandidateGatedSandboxLayoutResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_gated_sandbox_layout_only: bool = True
    advisory_only: bool = True
    ...
    gated_preflight_ready_is_not_production_authorization: bool = True
    latest: Optional[dict[str, Any]] = None
    compact: MrmsRenderCandidateGatedSandboxLayoutCompact


class MrmsRenderCandidateGatedManifestIoCompact(BaseModel):
    available: bool = False
    review_status: Optional[str] = None
    preflight_level: Optional[str] = None
    preflight_reason: Optional[str] = None
    ...
    sandbox_status: Optional[str] = None
    sandbox_reason: Optional[str] = None
    sandbox_layout_blockers: list[str] = Field(default_factory=list)
    sandbox_root: Optional[str] = None
    manifest_io_skipped: bool = True
    import_export_status: Optional[str] = None
    import_export_reason: Optional[str] = None
    manifest_io_blockers: list[str] = Field(default_factory=list)
    manifest_io_warnings: list[str] = Field(default_factory=list)
    ...
    next_phase_recommendation: Optional[str] = None
    verified_mrms: bool = False
    local_gated_manifest_io_only: bool = True
    advisory_only: bool = True
    does_not_clear_alerts: bool = True
    does_not_enable_production: bool = True
    does_not_download_or_decode: bool = True
...
class MrmsRenderCandidateGatedManifestIoResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_gated_manifest_io_only: bool = True
    advisory_only: bool = True
    ...
    gated_preflight_ready_is_not_production_authorization: bool = True
    latest: Optional[dict[str, Any]] = None
    compact: MrmsRenderCandidateGatedManifestIoCompact


class MrmsRenderCandidateGatedComparisonHistoryCompact(BaseModel):
    available: bool = False
    review_status: Optional[str] = None
    preflight_level: Optional[str] = None
    preflight_reason: Optional[str] = None
    ...
    import_export_reason: Optional[str] = None
    manifest_io_blockers: list[str] = Field(default_factory=list)
    comparison_skipped: bool = True
    history_status: Optional[str] = None
    history_reason: Optional[str] = None
    history_count: int = 0
    comparison_history_blockers: list[str] = Field(default_factory=list)
    comparison_history_warnings: list[str] = Field(default_factory=list)
    ...
    next_phase_recommendation: Optional[str] = None
    verified_mrms: bool = False
    local_gated_comparison_history_only: bool = True
    advisory_only: bool = True
    does_not_clear_alerts: bool = True
    does_not_enable_production: bool = True
    does_not_download_or_decode: bool = True
...
class MrmsRenderCandidateGatedComparisonHistoryResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_gated_comparison_history_only: bool = True
    advisory_only: bool = True
    ...
    gated_preflight_ready_is_not_production_authorization: bool = True
    latest: Optional[dict[str, Any]] = None
    compact: MrmsRenderCandidateGatedComparisonHistoryCompact


class MrmsRenderCandidateGatedTrendReviewCompact(BaseModel):
    available: bool = False
    review_status: Optional[str] = None
    preflight_level: Optional[str] = None
    preflight_reason: Optional[str] = None
    ...
    trend_blockers: list[str] = Field(default_factory=list)
    ...
    next_phase_recommendation: Optional[str] = None
    verified_mrms: bool = False
    local_gated_trend_review_only: bool = True
    advisory_only: bool = True
    does_not_clear_alerts: bool = True
    does_not_enable_production: bool = True
    does_not_download_or_decode: bool = True
...
class MrmsRenderCandidateGatedTrendReviewResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_gated_trend_review_only: bool = True
    advisory_only: bool = True
    ...
    gated_preflight_ready_is_not_production_authorization: bool = True
    latest: Optional[dict[str, Any]] = None
    compact: MrmsRenderCandidateGatedTrendReviewCompact


class MrmsRenderCandidateGatedComparisonAckCompact(BaseModel):
    available: bool = False
    review_status: Optional[str] = None
    preflight_level: Optional[str] = None
    preflight_reason: Optional[str] = None
    ...
    next_phase_recommendation: Optional[str] = None
    verified_mrms: bool = False
    local_gated_comparison_ack_only: bool = True
    advisory_only: bool = True
    does_not_clear_alerts: bool = True
    does_not_enable_production: bool = True
    does_not_download_or_decode: bool = True
...
class MrmsRenderCandidateGatedComparisonAckResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_gated_comparison_ack_only: bool = True
    advisory_only: bool = True
...
class MrmsRenderCandidateTrendHintAckStatusCompact(BaseModel):
    available: bool = False
    rollup_status: Optional[str] = None
    acknowledgment_status: Optional[str] = None
    status_reason: Optional[str] = None
...
class MrmsRenderCandidateTrendHintAckStatusResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_status_rollup_only: bool = True
    advisory_only: bool = True
...
class MrmsRenderCandidateTrendHintAckStatusHistoryCompact(BaseModel):
    available: bool = False
    history_count: int = 0
    latest_rollup_status: Optional[str] = None
    latest_acknowledgment_status: Optional[str] = None
...
class MrmsRenderCandidateTrendHintAckStatusHistoryResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_status_history_only: bool = True
    advisory_only: bool = True
...
class MrmsRenderCandidateTrendHintReviewDigestHistoryCompact(BaseModel):
    available: bool = False
    history_count: int = 0
    latest_digest_status: Optional[str] = None
    latest_rollup_status: Optional[str] = None
    latest_coverage_change: Optional[str] = None
    latest_recorded_at: Optional[str] = None
    recent_entries: list[dict[str, Any]] = Field(default_factory=list)
    ...
    next_phase_recommendation: Optional[str] = None
    verified_mrms: bool = False
    local_digest_history_only: bool = True
    advisory_only: bool = True
    does_not_clear_alerts: bool = True
    does_not_enable_production: bool = True
    does_not_download_or_decode: bool = True
...
class MrmsRenderCandidateTrendHintReviewDigestHistoryResponse(BaseModel):
    prototype: bool = True
    verified_mrms: bool = False
    local_digest_history_only: bool = True
    advisory_only: bool = True
...
class ValidationSummaryResponse(BaseModel):
    ...
    mrms_render_candidate_trend_hint_chain_bootstrap: Optional[
        MrmsRenderCandidateTrendHintChainBootstrapCompact
    ] = None
    ...
    mrms_render_candidate_gated_sandbox_layout: Optional[
        MrmsRenderCandidateGatedSandboxLayoutCompact
    ] = None
    mrms_render_candidate_gated_manifest_io: Optional[
        MrmsRenderCandidateGatedManifestIoCompact
    ] = None
    mrms_render_candidate_gated_comparison_history: Optional[
        MrmsRenderCandidateGatedComparisonHistoryCompact
    ] = None
    mrms_render_candidate_gated_trend_review: Optional[
        MrmsRenderCandidateGatedTrendReviewCompact
    ] = None
