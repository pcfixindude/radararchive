"""Tests for trend review acknowledgment status trend hint review acknowledgments (Phase 77)."""
...
from backend.app.services.mrms_render_candidate_sandbox_comparison_acknowledgment_status_trend_review_acknowledgment_status_trend_review_acknowledgment import (
    ...
    load_ack_status_trend_review_acknowledgment_status_trend_review_acknowledgments,
)
...
def test_acknowledgment_safety_invariants(storage, monkeypatch):
    ...
    compact = compact_ack_status_trend_review_acknowledgment_status_trend_review_acknowledgment_summary(storage)
...
def test_acknowledgment_get_endpoint(client, storage, monkeypatch):
    ...
    response = client.get(
        ...
        "comparison-acknowledgment-status/trend-review-acknowledgment-status/trend-review-acknowledgments"
    )
